...
public class AccueilServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (livreList.size() > 3) {
                request.setAttribute("livresEnavant", livreList.subList(livreList.size() - 4, livreList.size()));
//                request.setAttribute("livresEnavant", livreDAOImpl.chercherTitreOuAuteur("ovar")  );
            } else {
                request.setAttribute("livresEnavant", livreList);
            }
