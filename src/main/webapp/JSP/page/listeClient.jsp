    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8">
                ...
                <p>CSRF Token: <c:out value="${requestScope.csrfToken}"/></p>
                        ...
                        <tr id="row${client.clientId}">
                            ...
                            <td>
                                <a class="btn btn-outline-primary rounded-0"
                                   href="${pageContext.request.contextPath}/ModifClient?id=${client.clientId}&csrf=${requestScope.csrfToken}">Modifier</a>
