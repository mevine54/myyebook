        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="d-flex justify-content-center my-3">
                    <h2>Modification d'un Catégorie</h2>
                </div>
                <form class="mx-auto col-lg-7" method="POST" action="LivreModification">
                    <a href="${pageContext.request.contextPath}/Ls" class="btn btn-outline-primary fw-bold rounded-0 mb-3 px-3"><i class="bi bi-arrow-left-short"></i> Retour</a>
                    <div class="row mb-3">
                        <div class="col">
