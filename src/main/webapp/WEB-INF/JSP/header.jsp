                                ...
                                <a href="<c:out value="${deconnexionUrl}"/>"
                                   class="ms-auto d-flex flex-wrap justify-content-lg-center align-items-center m-2 m-lg-0 link-underline link-underline-opacity-0 link-underline-opacity-0-hover text-white">
                                    <img src="<c:url value='/assets/images/logout.svg'/>"
                                         class="rounded-circle img-thumbnail me-2" alt="Image d'un livre">
                                    Se déconnecter
                                </a>
                            </c:when>
                            <c:otherwise>
                                <a href="${clientenregistrerUrl}"
                                   class="d-flex flex-wrap justify-content-lg-center align-items-center m-2 m-lg-0 link-underline link-underline-opacity-0 link-underline-opacity-0-hover text-white">
                                    <img src="<c:url value='/assets/images/person-plus.svg'/>"
                                         class="rounded-circle img-thumbnail me-2" alt="Image d'un livre">
                                    S'inscrire
                                </a>
                                <a href="${connexionUrl}"
                                   class="d-flex flex-wrap justify-content-lg-center align-items-center m-2 m-lg-0 link-underline link-underline-opacity-0 link-underline-opacity-0-hover text-white">
                                    <img src="<c:url value='/assets/images/exit_to_app.svg'/>"
                                         class="rounded-circle img-thumbnail me-2" alt="Image d'un livre">
                                    Se connecter
                                </a>
                            </c:otherwise>
