    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center fs-2 mt-2">
            <div class="row">
                <div class="col">
                    <a href="">
                        <img class="bi bi-facebook link-opacity-100-hover" src="assets/images/facebook.svg" alt="facebook">

                    </a>
                </div>
                <div class="col">
                    <a href="">
                        <img class="bi bi-twitter link-opacity-100-hover" src="assets/images/twitter.svg" alt="twitter">
                    </a>
                </div>
                <div class="col">
                    <a href="">
                        <img class="bi bi-instagram link-opacity-100-hover" src="assets/images/instagram.svg" alt="instagram">
                    </a>
                </div>
                <div class="col">
                    <a href="">
                        <img class="bi bi-linkedin link-opacity-100-hover" src="assets/images/linkedin.svg" alt="linkedin">
                    </a>
                </div>
            </div>
        </div>
